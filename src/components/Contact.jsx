  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#001427] flex justify-center items-center p-4'>
        <form  method="POST" action="https://getform.io/f/57a09d20-a37b-4236-ac90-f17cc2dee67d" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-[#9E2A2B] text-gray-300'>Contact</p>
            ...
            <button className='text-white border-2 hover:bg-[#9E2A2B] hover:border-[#9E2A2B] px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
